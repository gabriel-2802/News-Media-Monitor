...
@Service
@Slf4j
public class ClusterServiceImpl1 implements ClusterService {
    private final String clusteringUrl;
    private final RestTemplate restTemplate = new RestTemplate();

    public ClusterServiceImpl1(@Value("${clustering.api.url:http://localhost:8000/cluster}") String clusteringUrl) {
